...
class VersioningSpec extends BaseSpec {
  ...
  private val sandboxMatchEndpointWithSandboxMatchId = "/sandbox/match/57072660-1df9-4aeb-b4ea-cd2d7f96e430"
        ...
        """
          {
            "_links":{
              "paye":{
                "href":"/individuals/employments/paye/match/57072660-1df9-4aeb-b4ea-cd2d7f96e430{?fromDate,toDate}",
                "title":"View individual's employments"
              },
              "self":{
                "href":"/individuals/employments/match/57072660-1df9-4aeb-b4ea-cd2d7f96e430"
              }
            }
          }
        """)
